...
if __name__ == "__main__":
    ...
    Kset = [6, 6, 8, 8, 10, 12, 14, 16, 16, 18, 18, 20, 22, 24, 24]  # 进行运算的邻居参数k取值，升序 tae
    ThresholdSet = [1.4260, 1.3484, 1.3782, 1.4936, 1.4979, 1.4276, 1.1258, 1.3345, 1.0987, 1.4117, 1.51, 1.0397, 1.3804, 1.1209, 1.3655, 1.1023]#tae
    Tset = [0.1, 0.2, 1.5, 1.6, 1.7, 1.8, 1.9]#tae
    ...
    np.savetxt("./tae-normal.txt", data)#改改改
    #print(data[:10])
