...
if __name__ == "__main__":
    ...
    global photoPath
    savePath = ""
    filePath = "./seeds_dataset.txt"#改改改
    ...
    # ThresholdSet = [1.8342, 1.7946, 1.8055, 1.7289, 1.7182, 1.7174, 1.6757, 1.6644, 1.6987, 1.7202]
    # ThresholdSet = [1.7125, 1.8342, 1.7946, 1.7068, 1.8055, 1.689, 1.6612, 1.7289, 1.7182, 1.6905, 1.7174, 1.6324, 1.6757, 1.6644, 1.6053, 1.6094, 1.6987, 1.7202]#seeds
    Tset = [0.7, 0.8, 0.9, 1., 1.1]
    ...
    np.savetxt("./seeds-normal.txt", data)#改改改
    #print(data[:10])
