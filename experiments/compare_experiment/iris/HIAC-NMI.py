...
if __name__ == "__main__":
    ...
    # ThresholdSet = [1.4996, 1.4635, 1.4286, 1.3764, 1.305, 1.2945, 1.3960, 1.3246, 1.387, 1.3783, 1.3148, 1.3911, 1.3693, 1.2958, 1.3834, 1.3764]#iris
    Tset = [0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1.2]
    ...
    np.savetxt("./iris-normal.txt", data)#改改改
    #print(data[:10])
