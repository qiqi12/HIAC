...
if __name__ == "__main__":
    ...
    #ThresholdSet = [2.908, 3.117, 3.022, 2.928, 3.039, 3.034, 3.085, 2.98, 2.804, 3.064, 2.935, 3.088, 3.03]digit
    Tset = [0.2, 0.3, 0.4, 0.5]
    ...
    np.savetxt("./digit-normal.txt", data)#改改改
    #print(data[:10])
