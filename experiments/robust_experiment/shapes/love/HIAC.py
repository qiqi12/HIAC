...
def Plot(data, labels):
    ...
    color = ['#FF5F00', '#B91646', '#4700D8', '#4D96FF', '#FFD93D', '#FF6363', '#CE49BF', '#22577E', '#4700D8', '#F900DF', '#95CD41',
              '#125B50', '#40DFEF', '#8E3200',  '#C36A2D', '#001E6C']  # 正常数据集
